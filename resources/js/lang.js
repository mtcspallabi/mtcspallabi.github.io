      ...
      resources: {
        en: {
          special: {
            ...
            header: {
              dialogue_header:
                "Your child, it's our responsibility to develop his/her intellect.",
            ...
            sectionFeature: {
              ...
              feature_p_1:
                "Hello, we beleive in quality education for your child to develop his/her thought process. We know you're always thoughtful                 about your child education . So let us take care of that, we're really good at it, we promise!",
              feature_h3_1: "Play ground and auditorium",
              feature_p_2:
                "We have nice playground and auditorium in side. We beleive your child like to play than reading all time. We encourage them                 to play and perform.",
              feature_h3_2: "Text book classes are 5 days/week",
              feature_p_3:
                "Our text book education is 5 days per week. We don't beleive in pressure but like to give your child a space so that student               can enjoy the vacation with co-education.",
              feature_h3_3: "Focus on moral education",
              feature_p_4:
                "We provide value based education is needed for developing moral qualities such as humility, truthfulness, honesty, courtesy,               tolerance, sacrifice etc among the youth.",
              feature_h3_4: "Co education on every Saturday",
              feature_p_5:
                "We offer co-education for student which includes drawing, dancing and singing as well."
            },
            gallery: {
            ...
            location: {
              ...
              location_h3_1:
                "1/C & 1/B, Pallabi, Section-12, Mirpur, Dhaka-1216"
            },
            testimonial: {
            ...
            footer: {
              ...
              footer_p_1:
                "Copyright &copy; 2020 by MTCS. All rights reserved. Courtesy- Jonas Schedmann."
            },
            notice: {
        ...
        bn: {
          special: {
            ...
            header: {
              dialogue_header:
                "সন্তান আপনার, তার মেধা'র সুষ্ঠ বিকাশের দায়িত্ব আমাদের।",
            ...
            sectionFeature: {
              ...
              feature_p_1:
                "আমরা আপনার সন্তানের  মেধা'র সুষম  বিকাশের জন্য মানসম্মত শিক্ষার প্রতি আগ্রহী। আমরা জানি আপনি সর্বদা আপনার শিশু'র সু-শিক্ষার বিষয়ে চিন্তাশীল।                      এতদ্ববিষয়ে আমরা শিক্ষার্থীদের বিশেষ যত্ন নিয়ে থাকি  এবং আমরা  প্রতিশ্রুতিবদ্ধ!",
              feature_h3_1: "খেলার মাঠ এবং মিলনায়তন",
              feature_p_2:
                "আমাদের স্কুল চত্বরে সুন্দর খেলার মাঠ এবং মিলনায়তন রয়েছে। আমরা বিশ্বাস করি আপনার শিশুটি  পড়ার চেয়ে খেলতে বেশী পছন্দ করে। আমরা তাদের  শিক্ষার পাশাপাশি                খেলাধুলা এবং ছবি আঁকা, নাচ ও গান করতে উত্সাহিত করি ।",
              feature_h3_2: "পাঠ্য পুস্তক শিক্ষা সপ্তাহে  ৫  দিন ",
              feature_p_3:
                "আমাদের পাঠ্য বইয়ের শিক্ষা কার্য্যক্রম প্রতি সপ্তাহে ৫ দিন। আমরা পুঁথিগত পড়ালেখা'র অতিরিক্ত চাপ প্রয়োগে  বিশ্বাসী নই, আমরা চাই একজন শিক্ষার্থী যেন                   শ্রেনীকক্ষেই সহজ পাঠ-পরিকল্পনা বুঝতে আগ্রহী হয় যাতে করে তারা সহশিক্ষা কার্য্যক্রমে অংশ নিয়ে ছুটি  উপভোগ  করতে পারে।",
              feature_h3_3: "নৈতিক শিক্ষা",
              feature_p_4:
                "শিক্ষার্থীদের মধ্যে নম্রতা, সত্যবাদিতা, সততা, সৌজন্যতা, সহনশীলতা, ত্যাগ ইত্যাদির মতো নৈতিক গুণাবলির বিকাশের জন্য আমরা সময়োপযোগী নৈতিক শিক্ষা প্রদানে                 সর্বদা সচেষ্ট।",
              feature_h3_4: "প্রতি শনিবার সহশিক্ষা কার্য্যক্রম",
              feature_p_5:
                "আমরা শিক্ষার্থীদের জন্য সহশিক্ষা (অঙ্কন, নাচ এবং গান) কার্য্যক্রম  পরিচালনা করে থাকি যা গ্রন্থগত বিদ্যার পাশাপাশি একজন শিক্ষার্থী'র শিল্পী সত্তাকে জাগ্রত করতে                   সহায়ক ভূমিকা পালন করে।"
            },
            gallery: {
              gallery_h2_1: "ছবি ঘর"
            },
            message: {
              ...
              message_p_1:
                "আজ, একটি বিদ্যালয়ের ভূমিকা কেবলমাত্র একাডেমিক শ্রেষ্টত্ব  অর্জনের জন্য নয়।  শিক্ষার্থীদের আজীবন শিক্ষানবিস, সমালোচক, চিন্তাবিদ এবং একটি পরিবর্তিত বৈশ্বিক সমাজের উত্পাদনশীল সদস্য হতে অনুপ্রেরণা ও ক্ষমতায়িত করাও মূখ্য ব্রত। ২০০৯ খৃষ্টাব্দ হতে প্রায় এক দশক সময় ধরে  আমরা শিক্ষা'র পঠ পরিবর্তনের প্রতিশ্রুতি নিয়ে অগ্রসর হচ্ছি। সুপ্রতিষ্ঠিত ম্যানেজমেন্ট  এর নেতৃত্বে পরিচালিত এই বিদ্যালয়টি কেবল পল্লবী নয়, অত্র মিরপুর এলাকায় একটি স্বনামধন্য শিক্ষাবান্ধব পরিবেশ প্রদানে সক্ষম হবে । এখানে আমরা আমাদের শিক্ষার্থীদের বহুমুখী বিকাশের জন্য একটি পরিবেশ প্রদান করি, যেখানে বাচ্চাদের শ্রেষ্ঠত্বের সন্ধানে তাদের সম্ভাব্যতাগুলি চ্যানেলাইজ করতে উত্সাহিত করা হয়।",
              message_figcaption_2:
                "<b>ভাইস প্রিন্সিপাল  সিস্টার তুলি দ্রং</b>",
              message_p_2:
            ...
            location: {
              ...
              location_h3_1:
                "১ / সি ও ১ / বি, পল্লবী, সেকশন-১২, মিরপুর, ঢাকা -১২১৬"
            },
            testimonial: {
            ...
            footer: {
              ...
              footer_p_1:
                "কপিরাইট &copy; ২০২০ , এম.টি.সি.এস.  কর্তৃক  সর্ব  সত্ব  সংরক্ষিত । সৌজন্যে - জোনাস শিডম্যান ।"
            },
            notice: {
